...
- Создание рабочей директории документов (`documents`)
...
Проверьте, что документы вставлены (`documents` содержит JSON-хранилища) или запустите заново `insert_pydantic_docs.py`.
